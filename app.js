...
function previewReceivedBalance(id){
  ...
  input.value = (Number(a.balance||0)+Number(p.amount||0)).toFixed(2);
  document.getElementById('receivedBalanceHelp').textContent = `Current balance ${fmtMoney(a.balance)} + paycheck ${fmtMoney(p.amount)}`;
}
